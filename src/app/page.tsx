...
export default function Home() {
  return (
    <Container>
      ...
      <Paragraph className="max-w-xl mt-4">
        Actuellement en 2 eme anné de BTS SIO option SLAM, je suis passionné par le développement web. J&apos;ai commencé à apprendre le développement web au debut de ma formationet j&apos;ai appris en autodidacte en parrallèle de ce celle ci.
      </Paragraph>
      <Paragraph className="max-w-xl mt-4">
